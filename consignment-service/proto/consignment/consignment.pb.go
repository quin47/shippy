...
type ShippingServiceClient interface {
	...
	GetAllConsignment(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error)
}
...
func (c *shippingServiceClient) GetAllConsignment(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error) {
...
func (h *ShippingService) GetAllConsignment(ctx context.Context, in *GetRequest, out *Response) error {
