...
func (c *shippingService) GetAllConsignment(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "ShippingService.GetAllConsignment", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterShippingServiceHandler(s server.Server, hdlr ShippingServiceHandler, opts ...server.HandlerOption) {
	type shippingService interface {
		...
		GetAllConsignment(ctx context.Context, in *GetRequest, out *Response) error
	}
	type ShippingService struct {
		shippingService
	}
...
func (h *shippingServiceHandler) GetAllConsignment(ctx context.Context, in *GetRequest, out *Response) error {
